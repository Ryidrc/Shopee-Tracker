...
export const VideoLogModal: React.FC<VideoLogModalProps> = ({ isOpen, onClose, onSubmit, pricingItems, initialData }) => {
  ...
  useEffect(() => {
    if (isOpen) {
      if (initialData) {
        ...
        // Try to find product name for context
  ...
  }, [isOpen, initialData, pricingItems]);
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="mt-3 space-y-3 animate-fade-in">
                    <div>
                        ...
                        <textarea 
                            ...
                            className="w-full text-xs p-2 rounded border border-indigo-200 dark:border-indigo-800 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-indigo-500 focus:border-indigo-500"
                            rows={2}
          ...
          <div className="pt-4 border-t border-slate-100 dark:border-slate-700">
             <div className="flex justify-between items-center mb-2">
                 <h3 className="text-sm font-bold text-slate-800 dark:text-white">Performance Metrics</h3>
